  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <a
          href="#"
          className="font-serif text-xl text-white tracking-tight hover:text-teal-400 transition-colors"
        >
      ...
      {menuOpen && (
        <nav className="md:hidden border-t border-white/5 bg-navy-950/98 backdrop-blur-xl px-6 py-6 flex flex-col gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 text-center rounded-full border border-teal-500/40 bg-teal-500/10 px-5 py-3 text-teal-400 font-medium"
            onClick={() => setMenuOpen(false)}
          >
            LinkedIn
          </a>
